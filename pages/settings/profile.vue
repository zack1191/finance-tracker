<template>
  <UForm :state="state" :schema="schema" @submit="saveProfile">
    ...
    <UFormGroup
      ...
      label="Email"
      name="email"
      help="You will receive a confirmation email on both the old and the new address if you modify the email address."
    >
...
const saveProfile = async () => {
  ...
  try {
    ...
    toastSuccess({
      ...
      description: "Your proifle has been updated.",
    });
  } catch (error) {
    toastError({
